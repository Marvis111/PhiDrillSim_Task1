...
import { View, Text, TextInput,Image, StyleSheet, ScrollView, TouchableOpacity, Alert, Number } from 'react-native';
import { useNavigation} from '@react-navigation/native';
import { Platform, PermissionsAndroid,Switch } from 'react-native';
...
const TargetsScreen: React.FC = () => {
  ...
  const toggleModal = () => {
    ...
    const processXLSX = (base64Content) => {
      try {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.modalContent}>
        ...
        <Image
          source={require('../src/excel.png')} // Adjust the path to your image
          style={styles.icon}
        />
      </TouchableOpacity>
